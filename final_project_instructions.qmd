...
Function for selecting a function and viewing Political Engagement alongside spread
```{python}
#return table
...
def engagement_spread_graph_D(df):
        graph = alt.Chart(df).mark_bar().encode(
        alt.X("US State 2", title = "State"),
        alt.Y("Spread_Dem", title = "Spread of Views"),
        alt.Color("political_engagement_score"),
        ).properties(
...
def engagement_spread_graph_R(df):    
        graph = alt.Chart(df).mark_bar().encode(
        alt.X("US State 2", title = "State"),
        alt.Y("Spread_Repub", title = "Spread of Views"),
        alt.Color("political_engagement_score"),
        ).properties(
            title = alt.TitleParams(
