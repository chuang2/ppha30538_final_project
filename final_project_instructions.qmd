...
# Attribution: Asked ChatGPT how to add a regression line to the chart. ChatGPT suggested using transform_regression() function
...
Regression_Graph = alt.Chart(main_group).transform_regression(
    ...
    alt.Y("political_engagement_score",
          title="Average Political Engagement Score")
)

# Combine scatter plot with regression line
Correlation_Graph_With_Regression = alt.layer(
    Correlation_Graph,  # Original scatter plot
    Regression_Graph    # Regression line
).properties(
    title="Correlation between Volunteer Hours and Political Engagement with Regression"
)
...
```{python}
print(filtered_main_group["Hours_Spent_Volunteering"].dtype)
print(filtered_main_group["political_engagement_score"].dtype)
