...
from config import pes16_dict, pes16d_dict, pts16e_dict, pes2_dict, pes5_dict, pes13_dict, pes14_dict, pes15_dict, pes15a_dict, pes7_dict, pes11_dict, pes9_dict, pes10_dict, prtage_dict, pesex_dict, ptdtrace_dict, pemaritl_dict, hrnumhou_dict, hefaminc_dict, peeduca_dict, gtmetsta_dict
import importlib
import config
...
cev_all_2021_filter['Number_Of_Groups'] = cev_all_2021_filter['Number_Of_Groups'].map(
    pes15a_dict)
