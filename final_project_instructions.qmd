...
cev_2019_raw = pd.read_csv("/Users/charleshuang/Documents/GitHub/student30538/problem_sets/final_project/data/2019_CEV_Data__Current_Population_Survey_Civic_Engagement_and_Volunteering_Supplement_20241129.csv", encoding = 'utf-8')
...
vcl_2019_raw = pd.read_csv("/Users/charleshuang/Documents/GitHub/student30538/problem_sets/final_project/data/sep19pub.csv")
...
# Test script to debug pes16_dict import
import config
print(config.__file__)  # Check the path to ensure correct file is loaded

from config import pes16_dict
print(pes16_dict)  # Ensure the dictionary is accessible
