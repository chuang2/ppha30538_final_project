...
top_bottom_labels = alt.Chart(top_bottom_states).mark_text(
    align='left',  # Align text to the left of the point
    baseline='middle',
    dx=10  # Offset text slightly from the points
).encode(
    x=alt.X('US State:N', title='US State', sort='-y'),
    y=alt.Y('Hours_Spent_Volunteering:Q',
            title='Average Hours Spent Volunteering'),
    # Add text from the Hours_Spent_Volunteering column
    text=alt.Text('Hours_Spent_Volunteering:Q')
)
