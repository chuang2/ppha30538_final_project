...
cev_2021_raw = pd.read_csv("C:/Users/andre/Documents/GitHub\DAP_2_Temp_HW_Holder/Data/2021_CEV_Data__Current_Population_Survey_Civic_Engagement_and_Volunteering_Supplement_20241127.csv", encoding = 'utf-8')
...
First, clean data to produce some geographic information:

We will use V201014b, a variable that makes note of the state in 
which a respondent is registered to vote, and use it to make a 
variable called US State. We are using it to form US State 2, not US State, 
because V201013a is US State, and that variable has fewer rows.
